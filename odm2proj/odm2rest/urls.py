...
from odm2rest.result_views import ResultsViewSet, ResultsVarCodeViewSet, ResultsSFCodeViewSet, ResultsSFUUIDViewSet, \
    ResultsBBoxViewSet, ResultsActionDateViewSet, ResultsRTypeCVViewSet, ResultsComplexViewSet
...
urlpatterns = [
    ...
    url(r'^Observations/variableCode/(?P<variableCode>.+)/$', ResultsVarCodeViewSet.as_view(),
        name='resultvarcode-list'),
    url(r'^Observations/samplingfeatureCode/(?P<samplingfeatureCode>.+)/$', ResultsSFCodeViewSet.as_view(),
        name='resultsfcode-list'),
    url(r'^Observations/samplingfeatureUUID/(?P<samplingfeatureUUID>.+)/$', ResultsSFUUIDViewSet.as_view(),
        name='resultsfuuid-list'),
    ...
    url(r'^sites/samplingfeatureCode/(?P<samplingfeatureCode>.+)/$', SiteSamplingFeatureCodeViewSet.as_view(),
        name='site-detail-sfc'),
    ...
    url(r'^externalidentifiers/citation/$', ExternalIdentifierCitationViewSet.as_view(),
        name='externalidentifier-citation-list'),
    url(r'^externalidentifiers/people/$', ExternalIdentifierPeopleViewSet.as_view(),
        name='externalidentifier-people-list'),
    url(r'^externalidentifiers/samplingfeature/$', ExternalIdentifierSamplingFeatureViewSet.as_view(),
        name='externalidentifier-sf-list'),
    url(r'^samplingfeatures/$', SamplingfeatureViewSet.as_view(), name='sf-list'),
    url(r'^samplingfeatures/samplingfeatureCode/(?P<samplingfeatureCode>.+)/$', SFCodeViewSet.as_view(),
        name='sf-detail-sfc'),
    url(r'^samplingfeatures/samplingfeatureType/(?P<samplingfeatureType>.+)/$', SFTypeViewSet.as_view(),
        name='sf-detail-sft'),
]
