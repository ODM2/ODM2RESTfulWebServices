...
affiliation_join = result_aliased_table.join(affiliation_table,
                                             affiliation_table.c.affiliationid == result_aliased_table.c.PID)
source_join = affiliation_join.join(organization_table,
                                    affiliation_join.c.odm2_affiliations_organizationid == organization_table.c.organizationid)
...
joined_table = joined_table.join(feature_action_table,
                                 feature_action_table.c.featureactionid == result_aliased_table.c.FAID)
